...
public class CollarMAC222 extends Applet {
    ...
    public static void install(byte[] b, short o, byte l) {
        new CollarMAC222().register();
    }

    private CollarMAC222() {
        ...
        // WARNING: ALG_AES_MAC_128_NOPAD is raw CBC-MAC (not CMAC!).
        // It requires 16-byte-aligned input and produces a different
        // result than CMAC for the same key and message.
        // Use 16-byte challenges and CBC-MAC (not CMAC) on the host.
